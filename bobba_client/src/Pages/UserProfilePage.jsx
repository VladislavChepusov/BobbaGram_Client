...
componentDidMount(prevProps) {
    ...
    UserData.then((res) => {
      ...
      this.setState({
        avaratlink: (res.avatarLink !== null) ? 'https://localhost:7277' + res.avatarLink : "https://images.vexels.com/media/users/3/145908/preview2/52eabf633ca6414e60a7677b0b917d92-male-avatar-maker.jpg",
                  ...
                  <div className="card-body p-4 text-black">
                    <div className="mb-5">
                      ...
                      <div
                        ...
                        style={{ backgroundColor: "#f8f9fa" }}
                      >
                         <p className="font-italic mb-1">{this.state.description}</p>
