                    ...
                    <ul className="list-inline m-0">
                        <li className="list-inline-item">
                            <a href="#" className="link-menu">
                                <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" className="bi bi-house-door-fill"
                        ...
                        <li className="list-inline-item ml-2">
                            <a href="#" className="link-menu">
                                <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" className="bi bi-inboxes"
                                    fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                        ...
                        <li className="list-inline-item ml-2">
                            <a href="#" className="link-menu">
                                <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" className="bi bi-compass"
                                    fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                        ...
                        <li className="list-inline-item ml-2">
                            <a href="#" className="link-menu">
                                <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" className="bi bi-heart"
                                    fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
